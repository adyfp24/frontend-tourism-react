    ...
    return (
        <div className='bg-custom-100 h-full font-sans'>
            ...
            <section id='head-section' className='flex mx-8 sm:mx-16 flex-col-reverse sm:flex-row justify-between pt-14 sm:pt-8 mb-6 sm:mb-12'>
                <div className='flex flex-col font-sans w-full sm:w-1/2'>
                    ...
                    <div className='font-thin text-xl ml-1 mt-4 text-justify sm:mt-10'>
                        <p className=''>
                        Museum Angkut merupakan salah satu destinasi wisata favorit wisatawan saat berkunjung ke Malang, Jawa Timur. Salah satu daya tarik dari museum ini adalah banyaknya koleksi mobil-mobil hingga kendaraan lainnya. Daya tarik lain dari Museum Angkut adalah berbagai pertunjukan yang menarik dan memukau pengunjung.
                        </p>
                    </div>
                </div>
                <div className='flex justify-end w-full sm:w-1/2 sm:px-0'>
                    <img className='animate__animated animate__fadeInRight' src={museumImg} alt="" />
                </div>
            </section>

            <section id='content-section' className='mx-8 sm:mx-16 my-3 sm:my-6 font-sans'>
                <h3 className='font-medium text-xl sm:text-2xl'>Apa saja di Museum Angkut?</h3>
                    ...
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Gangster Town tebangun dengan inspirasi kota Chicago, Amerika. Bak di film-film seperti yang sering kita lihat, Gangster Town dibuat semirip mungkin dengan suasana Amerika</p>
                            </div>
                        </div>
                    </div>
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Pasar Apung merupakan salah satu zona di Museum Angkut. Sama halnya dengan pasar umum, di sini juga menjual berbagai macam barang</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Tak lengkap jika Museum Angkut namun tidak menampilkan angkutan atau transportasi. Berbagai koleksi mulai dari mobil, sepeda, kapal, pesawat, dan lain-lain menghiasi berbagai sudut Museum Angkut</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Zona Eropa menghadirkan vibes negara-negara eropa yang sangat identik dengan box telepon, bus merah, dan lain-lain</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Tak cuma berfokus pada transportasi, Museum Angkut juga mengadopsi tempat-tempat ikonik di dunia yang cocok untuk foto instagenikmu</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col '>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Mengusung tema Indonesia terkhusus di pulau Jawa pada tempo dulu membuat zona ini memiliki suasana vintage bak tahun 80 an</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id='activity' className='mx-8 sm:mx-16 my-3 sm:my-6 font-sans'>
                <h3 className='font-medium text-xl sm:text-2xl'>Rekomendasi aktivitas di Museum Angkut</h3>
                <div className="grid w-full py-6 sm:py-12 grid-cols-3 gap-2 sm:gap-10 sm:mb-12">
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            <div className='h-full sm:h-72 w-full'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Parade mobil dan kostum ini hanya dapat kamu nikmati di jam 16.30 sore yang berisi pertunjukan seru dari puluhan tokoh serta pertunjukan mobil yang pastinya memukau</p>
                            </div>
                        </div>
                    </div>
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Dengan berbagai sudut yang pastinya bagus tak lengkap jika tak mengabadikan momen-momen terlebih untuk foto instagenik</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>F1 adalah salah satu perlombaan balap mobil yang hanya dapat diikuti oleh yang berpengalaman. Namun, di sini kamu dapat merasakan sensasi berkendara bak pembalap F1 dengan simulasi berkendara F1</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Tak cuma menampilkan berbagai transportasi termasuk pesawat, tapi kamu juga bisa merasakan menerbangkan pesawat yang pastinya akan dipandu oleh petugas</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                <h1 className='font-bold my-4'>Mengunjungi Indonesian Heritage</h1>
                                <p className='font-thin'>Indonesia heritage museum merupakan taman hiburan dengan tema pameran adat budaya Jawa Timur yang dilengkapi dengan Science Center dan pembelajaran tentang budaya Indonesia.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 shadow-md rounded-xl bg-custom-300">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                <h1 className='font-bold py-4'>Menikmati Jakarta Tempoe Doloe</h1>
                                <p className='font-thin'>Parade mobil dan kostum ini hanya dapat kamu nikmati di jam 16.30 sore yang berisi pertunjukan seru dari puluhan tokoh serta pertunjukan mobil yang pastinya memukau</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex w-full flex-col'>
                        <div className='w-full h-full sm:h-36 flex mb-4'>
                            ...
                            <div className='flex flex-col w-8/12 ml-4  h-full'>
                                <h3 className='font-semibold text-sm sm:text-lg'>Pengen kesini lagi</h3>
                                <p className='text-xs sm:text-base font-thin text-justify'>Seru banget dehhh, apalagi pas bagian parade tuh rame banget, pokoknya kalo kalian liburan wajib banget mampir kesini</p>
                            </div>
                        ...
                        <div className='w-full h-full sm:h-36 flex mb-4'>
                            ...
                            <div className='flex flex-col w-8/12 ml-4  h-full'>
                                ...
                                <p className='text-xs sm:text-base font-thin text-justify'>Karena aku suka banget sam apermobilan, jadi ini surga banget sihh karena bisa lihat langsung, kesini ngajak sekeluarga happy semua</p>
                            </div>
                        ...
                        <div className='w-full h-full sm:h-36 flex mb-4'>
                            ...
                            <div className='flex flex-col w-8/12 ml-4  h-full'>
                                ...
                                <p className='text-xs sm:text-base font-thin text-justify'>Udah sering kesini tapi tetep seruu, saranku kalian datengnya sekitar jam 2 siang aja, jadi udah makan full energy baru keliling-keliling terus nanti ditutup sama parade mobil</p>
                            </div>
