  ...
  return (
    <div className="bg-custom-100 h-full font-sans">
      ...
      >
        <div className="flex flex-col font-sans w-full sm:w-1/2">
          ...
          <div className="font-thin text-xl ml-1 mt-4 text-justify sm:mt-10">
            <p className="">
              Alun-Alun Tugu Kota Malang merupakan salah satu
              simbol landmark dari Kota Malang, Jawa Timur. Tempat ini berbentuk
              lingkaran dengan tugu sebagai pusat dari tempat tersebut.
              Alun-Alun ini juga dilengkapi dengan lampu-lampu cantik yang
              bersinar di setiap malam. Di balik keindahannya, tempat ini
              menyimpan nilai sejarah, mulai dari zaman penjajahan Belanda
              hingga saat ini.
            </p>
          </div>
        </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="mb-16 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Monumen Tugu Malang merupakan ikon kota Malang yang terletak
                  di tengah alun-alun Malang. Monumen ini telah menjadi icon
                  kota malang dan kental akan sejarah perkembangan kota malang
                </p>
              </div>
            </div>
          </div>
          <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col">
              ...
              <div className="mb-6 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Terdapat bangunan kantor pejabat dan walikota malang, Gaya
                  bangunan pada balai kota malang masih bergaya kolonial kaena
                  memang merupakan peninggalan era belanda
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col">
              ...
              <div className="mb-16 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Terdapat pedestrian yang cukup luas dan dapat dilalui oleh
                  para pengunjung sambil bersantai dan menikmati keindahan taman
                  kota di sekitar tugu malang
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col">
              ...
              <div className="mb-16 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Tugu malang dikelilingi oleh taman kota yang terdapat
                  didalamnya aneka bunga baik bunga alami maupun bunga buatan.
                  Taman kota pun tampak semakin indah ketika menyala di malam
                  hari
                </p>
              </div>
            </div>
          ...
          <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col">
              ...
              <div className="mb-6 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Tugu Malang dikelilingi oleh kolam air bunga lil. Bunga lily
                  disini dimaknai dengan kesucian dan kebaikan
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col ">
              ...
              <div className="mb-6 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Hotel Tugu Malang adalah salah satu hotel terkenal di sekitar
                  Tugu Malang untuk mengakomodasi kemudahan perjalanan
                  pengunjung.
                </p>
              </div>
            </div>
      ...
      <section id="activity" className="mx-8 sm:mx-16 my-3 sm:my-6 font-sans">
        <h3 className="font-medium text-xl sm:text-2xl">
          Rekomendasi aktivitas di Tugu Malang
        </h3>
        <div className="grid w-full py-6 sm:py-12 grid-cols-3 gap-2 sm:gap-10 sm:mb-12">
          <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col">
              ...
              <div className="mb-16 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Siapapun pasti suka jajanan dan pastinya Daerah sekitar Tugu
                  Malang menghadirkan berbagai street food yang bisa kamu coba
                </p>
              </div>
            </div>
          </div>
          <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col">
              ...
              <div className="mb-6 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Pasar Minggu Gajahyana adalah salah satu pasar minggu yang
                  terkenal di Malang. Banyak variasi mulai dari makanan,
          ...
          <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col">
              ...
              <div className="mb-16 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Berkeliling Tugu Malang memang tak ada habisnya. Habiskan
                  waktu senggangmu dengan berjalan-jalan untuk menyegarkan badan
                  dan pikiran
                </p>
              </div>
            </div>
          ...
          <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col">
              ...
              <div className="mb-16 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Tak afdol jika berkeliling Tugu Malang yang ikonik tapi tidak
                  mengabadikan momen di setiap sudutnya yang indah.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
            <div className="flex flex-col">
              ...
              <div className="mb-6 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Menghabiskan waktu bersama keluarga, berbincang bersama, dan
                  bermain bersama tentu aktivitas yang sangat mengasyikkan
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="sm:col-span-1 shadow-md rounded-xl bg-custom-300">
            <div className="flex flex-col">
              ...
              <div className="mb-6 mx-4 hidden sm:block">
                ...
                <p className="font-thin">
                  Pemandangan yang bagus, rumput yang hijau dan sejuk cocok
                  untuk piknik bersama keluarga, teman, atau orang tersayang
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="w-full h-full sm:h-36 flex mb-4">
              ...
              <div className="flex flex-col w-8/12 ml-4  h-full">
                ...
                <p className="text-xs sm:text-base font-thin text-justify">
                  Monumen tugunya bagus, aku paling suka kolam air lilynya
                  karena memang itu bungan kesukaanku. Selalu menyenangkan
                  datang kesini apalagi bersama keluarga{" "}
                </p>
              </div>
            </div>
            ...
            <div className="w-full h-full sm:h-36 flex mb-4">
              <div className="flex w-4/12 h-full">
                ...
                <div className="flex flex-col pl-1 sm:pl-0 sm:mt-2">
                  ...
                  <h6 className="text-xs font-thin">20 Februari 2023</h6>
                </div>
              </div>
              <div className="flex flex-col w-8/12 ml-4  h-full">
                <h3 className="font-semibold text-sm sm:text-lg">
                ...
                <p className="text-xs sm:text-base font-thin text-justify">
                  Kemarin kesini gara-gara lagi suntuk aja sama kerjaan.
                  Ternyata bagus juga tugu malang ini. enak buat santai-santai
                  duduk. Kapan-kapan bakal kesini lagi buat refreshing
                </p>
              </div>
            </div>
            <div className="w-full h-0.5 mb-4 bg-gray-300"></div>
            <div className="w-full h-full sm:h-36 flex mb-4">
              <div className="flex w-4/12 h-full">
                ...
                <div className="flex flex-col pl-1 sm:pl-0 sm:mt-2">
                  ...
                  <h6 className="text-xs font-thin">2 Juli 2023</h6>
                </div>
              </div>
              <div className="flex flex-col w-8/12 ml-4  h-full">
                <h3 className="font-semibold text-sm sm:text-lg">
                ...
                <p className="text-xs sm:text-base font-thin text-justify">
                  Dikasih tau sama temen katanya di sini bagus buat foto-foto eh
                  ternyata bener , baguss apalagi enak banget daerah rumputnya
                  luas cocok buat santai-santai
                </p>
              </div>
            </div>
            <div className="w-full h-0.5 mb-4 bg-gray-300"></div>
