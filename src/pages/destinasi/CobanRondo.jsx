    ...
    return (
        <div className='bg-custom-100 h-full font-sans'>
            ...
            <section id='head-section' className='flex mx-8 sm:mx-16 flex-col-reverse sm:flex-row justify-between pt-14 sm:pt-8 mb-6 sm:mb-12'>
                <div className='flex flex-col font-sans w-full sm:w-1/2'>
                    ...
                    <div className='font-thin text-xl ml-1 mt-4 text-justify sm:mt-10'>
                        <p className=''>
                        Coban Rondo adalah tempat wisata berupa air terjun yang berada di Kabupaten Malang, Jawa Timur. Air terjun Coban Rondo memiliki ketinggian 84 meter dan berada di ketinggian 1.134 meter di atas permukaan laut (mdpl). Coban Rondo dikenal akan keindahan wisatanya.
                        </p>
                    </div>
                </div>
                <div className='flex justify-end w-full sm:w-1/2 sm:px-0'>
                    <img className='animate__animated animate__fadeInRight' src={cobanImg} alt="" />
                </div>
            </section>

            <section id='content-section' className='mx-8 sm:mx-16 my-3 sm:my-6 font-sans'>
                <h3 className='font-medium text-xl sm:text-2xl'>Apa saja di Coban Rondo?</h3>
                <div className="grid w-full py-6 sm:py-12 grid-cols-3 gap-2 sm:gap-10 sm:mb-12">
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Coban Rondo yang berarti air terjun tentu saja menyajikan pemandangan air terjunnya yang luar biasa</p>
                            </div>
                        </div>
                    </div>
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Untuk mengakomodasi kemudahan perjalanan pengunjung, banyak pihak yang menyediakan penginapan bagi pengunjuang</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            <div className='h-full sm:h-72 w-full'>
                                <img className='w-full max-h-full' src={lintasanSepeda} alt="" />
                            </div>

                            <div className='mb-16 mx-4 hidden sm:block'>
                                <h1 className='font-bold my-4'>Lintasan Sepeda</h1>
                                <p className='font-thin'>Pihak Coban Rondo terus berinovasi untuk berbagai fasilitas, termasuk fasilitas lintasan sepeda gunung</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Selain penginapan, Coban Rondo juga menyediakan camping ground bagi yang ingin merasakan sensasi camping di daerah sekitar air terjun</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Selian untuk sepeda gunung, jalan setapak Coban Rondo cocok bagi yang ingin jogging dengan pemandangan air terjun</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col '>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>wisata Coban Rondo memang terkenal dengan wahana taman labirin yang seru dan menantang. Bahkan rute labirin dapat diubah secara berkala.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id='activity' className='mx-8 sm:mx-16 my-3 sm:my-6 font-sans'>
                <h3 className='font-medium text-xl sm:text-2xl'>Rekomendasi aktivitas di Coban Rondo</h3>
                <div className="grid w-full py-6 sm:py-12 grid-cols-3 gap-2 sm:gap-10 sm:mb-12">
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            <div className='h-full sm:h-72 w-full'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Aktivitas satu ini tidak boleh terlewatkan jika ke Coban Rondo. Menaiki pelampung dan menyusuri sepanjang aliran air di Coban Rondo</p>
                            </div>
                        </div>
                    </div>
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Dengan bervariasinya penginapan/camping kamu tak perlu khawatir jika ingin menginap di dekat Coban Rondo</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Dengan disediakannya lintasan sepeda gunung, kamu bisa menikmati alam Coban Rondo dengan bersepeda santai</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 row-span-2 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-16 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Menaiki Jeep di daerah bebatuan dan hawa alam yang menyejukkan tentunya sangat menyenangkan</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 bg-custom-300 shadow-md rounded-xl">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Coban Rondo juga menghadirkan fasilitas berkuda yang cocok untuk segala usia</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="sm:col-span-1 shadow-md rounded-xl bg-custom-300">
                        <div className='flex flex-col'>
                            ...
                            <div className='mb-6 mx-4 hidden sm:block'>
                                ...
                                <p className='font-thin'>Flying fox adalah salah satu permainan yang ditawarkan di Coban Rondo dan jangan khawatir, kemanannya telah diuji</p>
                            </div>
                        </div>
                    </div>
                </div>
