...
function BlogDetail() {
  return (
    <div className='bg-custom-100 h-full font-sans'>
      <Navbar />
      <div className='pt-20 px-8 sm:px-16'>
        <h3 className='mb-1 font-extralight text-xs sm:text-sm'>Baca 3 menit</h3>
        <h1 className='mb-2 font-bold text-3xl sm:text-5xl '>Liburan? Museum Angkut, Yuk!</h1>
        ...
        <section id='main-content'>
          ...
          <p className='font-thin mb-6 text-justify'>
        ...
        <section id='ulasan' className=''>
          <div className='w-full h-full pb-4 sm:pb-0 sm:h-32 bg-white rounded-xl px-6'>
            <div className='flex justify-between items-center'>
              <div className='flex mt-4 items-center'>
                <img className='mr-3' src={profile} alt="" />
                <div className='flex flex-col sm:flex-row'>
                  <h3 className='font-medium'>Yuni Sarah</h3>
                  <h6 className='sm:mx-8 font-thin text-xs sm:text-base'>1 jam lalu</h6>
                </div>
              </div>
            ...
            <p className='mt-3 font-extralight text-sm sm:text-base text-gray-400'>Bagus banget emangg museum angkut. Aku kesana sama keluarga pas liburan anak-anak pada seneng sihh, bagus tempatnya bersih terawat</p>
          </div>
          <div className='w-full h-full pb-4 sm:pb-0 sm:h-32 bg-white rounded-xl px-6 my-6'>
            <div className='flex justify-between items-center'>
              <div className='flex mt-4 items-center'>
                <img className='mr-3' src={profile} alt="" />
                <div className='flex flex-col sm:flex-row'>
            ...
            <p className='mt-3 font-extralight text-sm sm:text-base text-gray-400'>Recomended kesini, tapi kalo udah musim liburan ya gitu deh rame banget, tapi worth it soalnya tempatnya bagus, ada juga musholanya jadi ga ribet kemana mana</p>
          </div>
          <div className='flex'>
            <div className='w-3 sm:w-1 sm:h-72 mx-4 sm:mx-8 bg-black'>
          ...
          <div className='w-full h-18 sm:h-32 bg-white rounded-xl px-3 sm:px-6 my-6'>
            <div className='flex justify-between items-center'>
              <div className='flex sm:mt-4 items-center justify-center'>
                <img className='mr-3' src={profile} alt="" />
              </div>
              <textarea placeholder='tambahkan ulasan' name="" id="" cols="9" rows="4" className='w-3/4 sm:mt-4 text-start items-center'></textarea>
              <div className='font-bold sm:text-base text-sm sm:mr-4'>
                <button className='px-3 sm:px-6 py-1 sm:py-2 text-white bg-custom-200 hover:bg-custom-300 rounded-xl'>Kirim</button>
              </div>
            </div>
          </div>
        </section>
